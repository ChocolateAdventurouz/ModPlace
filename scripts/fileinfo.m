...
Function fun_file_labels_enable_disable();
Function AntiAlias_Text();
...
AntiAlias_Text(){
	if (attr_antialias_mcv.getData() == "1"){
		g_title.setXmlParam("antialias", "1");
		g_album.setXmlParam("antialias", "1");
		g_artist.setXMLParam("antialias", "1");
		g_year.setXmlParam("antialias", "1");
		g_genre.setXmlParam("antialias", "1");
		g_track.setXMLParam("antialias", "1");
		g_Publisher.setXMLParam("antilias", "1");
		g_sname.setXmlParam("antialias", "1");
		g_surl.setXmlParam("antialias", "1");
		g_albumartist.setXMLParam("antialias", "1");
		g_composer.setXMLParam("antialias", "1");
		g_format.setXMLParam("antialias", "1");
		g_disc.setXMLParam("antialias", "1");
		t_rating.setXMLParam("antialias", "1");
	}
	else {
		g_title.setXmlParam("antialias", "0");
		g_album.setXmlParam("antialias", "0");
		g_artist.setXMLParam("antialias", "0");
		g_year.setXmlParam("antialias", "0");
		g_genre.setXmlParam("antialias", "0");
		g_track.setXMLParam("antialias", "0");
		g_Publisher.setXMLParam("antilias", "0");
		g_sname.setXmlParam("antialias", "0");
		g_surl.setXmlParam("antialias", "0");
		g_albumartist.setXMLParam("antialias", "0");
		g_composer.setXMLParam("antialias", "0");
		g_format.setXMLParam("antialias", "0");
		g_disc.setXMLParam("antialias", "0");
		t_rating.setXMLParam("antialias", "0");
	}
}

fun_file_labels_enable_disable(){
	if (attr_file_labels_enable_disable.getData() == "1"){

		g_title.setXmlParam("label", " ");
		g_album.setXmlParam("label", " ");
		g_artist.setXMLParam("label", " ");
		g_year.setXmlParam("label", " ");
		g_genre.setXmlParam("label", " ");
		g_track.setXMLParam("label", " ");
		g_Publisher.setXMLParam("label", " ");
		g_sname.setXmlParam("label", " ");
		g_surl.setXmlParam("label", " ");
		g_albumartist.setXMLParam("label", " ");
		g_composer.setXMLParam("label", " ");
		g_format.setXMLParam("label", " ");
		g_disc.setXMLParam("label", " ");
		t_rating.setXMLParam("label", " ");

		g_title.setXmlParam("x", "0");
		g_album.setXmlParam("x", "0");
		g_artist.setXMLParam("x", "0");
		g_year.setXmlParam("x", "0");
		g_genre.setXmlParam("x", "0");
		g_track.setXMLParam("x", "0");
		g_Publisher.setXMLParam("x", "0");
		g_sname.setXmlParam("x", "0");
		g_surl.setXmlParam("x", "0");
		g_albumartist.setXMLParam("x", "0");
		g_composer.setXMLParam("x", "0");
		g_format.setXMLParam("x", "0");
		g_disc.setXMLParam("x", "0");
		g_rating.setXMLParam("x", "0");
	}
	else {
		g_title.setXmlParam("label", "Title:");
		g_album.setXmlParam("label", "Album:");
		g_artist.setXMLParam("label", "Artist:");
		g_year.setXmlParam("label", "Year:");
		g_genre.setXmlParam("label", "Gerne:");
		g_track.setXMLParam("label", "Track:");
		g_Publisher.setXMLParam("label", "Publisher:");
		g_sname.setXmlParam("label", "Stream:");
		g_surl.setXmlParam("label", "Homepage:");
		g_albumartist.setXMLParam("label", "Album Artist:");
		g_composer.setXMLParam("label", "Composer:");
		g_format.setXMLParam("label", "Decoder:");
		g_disc.setXMLParam("label", "Disc:");
		t_rating.setXMLParam("label", "Rating:");


	}
}
attr_permanent_branding_enable_disable.onDataChanged(){
	if (attr_permanent_branding_enable_disable.getData() == "1"){
		showBranding();
	}
	else {
...
attr_file_labels_enable_disable.onDataChanged(){
	fun_file_labels_enable_disable();
}